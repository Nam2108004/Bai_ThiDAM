...
<body>
  ...
  <main style="display: flex; margin: 40px 80px" class="catalog  mb ">
    ...
    <div class="boxleft">
      <h2>Danh sách dung lượng</h2>
      <a href="?url=add-capacity"> <button class="learn-more"> Thêm danh mục
        </button></a>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td style="text-align: center;" class="suaxoa"><a href="?url=edit-capacity&id=<?php echo $row['id_dung_luong'] ?>">Sửa</a> </td>
              <td style="text-align: center;" class="suaxoa">
                <form method="post">
                  <input type="hidden" name="id_dung_luong" value="<?php echo $row['id_dung_luong'] ?>">
      ...
      <div class="mb">
        ...
        <div class="box_content2 product_portfolio">
          ...
          <ul>
            ...
            ?>
              <li><a href=""><?php echo $row['id_dung_luong'] ?></a></li>
            <?php }  ?>
          </ul>
...
<script>
  function confirmDelete(id) {
    if (confirm("Bạn có chắc chắn muốn xóa SP này?")) {
      window.location.href = "?url=delete-capacitys&id=" + id;
    }
  }
</script>
